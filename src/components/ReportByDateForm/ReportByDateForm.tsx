...
import { useReportByDateRange } from "../../hooks/useReportByDateByRange";
...
export const ReportByDateForm = () => {
    ...
    const { loading, error, success, reportByDateRange, resetState } = useReportByDateRange();
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        reportByDateRange(startDate, endDate);
    };
