            ...
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full">
                ...
                <div className="p-6">
                    <p className="text-gray-700 mb-4">
                        ¿Estás seguro de que deseas eliminar el flete del proveedor?
                    </p>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <div className="text-sm text-red-600">
                                    {flete.destination} • {flete.date}
                                </div>
                            </div>
                        </div>
                    </div>
                    <p className="text-sm text-gray-600">
                        Se eliminarán todos los datos asociados a este flete de forma permanente.
                    </p>
                </div>
